...
¿Qué dudas y problemas nos podemos encontrar a la hora de involucrarnos en un proceso colectivo de vivienda? queremos responder estas preguntas de manera colaborativa, conociendo las experiencias de otras personas, gente o colectivos que nos puedan asesorar y conectando con otros recursos online existentes.
  TEXT
  QUIENES =<<-'TEXT'
